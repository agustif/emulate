...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>none</td>
      <td><code>PersistenceAdapter</code> used to restore Store and token state across process restarts</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Stop the HTTP server, drain service side effects, capture final state, flush persistence writes, and surface the first failure</td>
    </tr>
  </tbody>
</table>
...
Custom adapters use the exported interface:
